# SWAN: SETUP
#  Purpose:
#    Handles all of the setup needed for the Swan map at round start.
#  End Effect:
...
#LOAD MAP
place template mas:swan1 -1455 19 -82
place template mas:swan2 -1455 19 -34
place template mas:swan3 -1503 19 -82
place template mas:swan4 -1503 19 -34
...
#SET SPAWNPOINTS // TODO (high): Fix these later, once SWAN is finished
