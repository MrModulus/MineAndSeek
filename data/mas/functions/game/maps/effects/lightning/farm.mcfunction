...
execute unless entity @e[type=minecraft:armor_stand,tag=mas.lightning,x=-61,y=26,z=60,dx=38,dy=24,dz=63,limit=1] run schedule function mas:game/maps/effects/lightning/farm 1t