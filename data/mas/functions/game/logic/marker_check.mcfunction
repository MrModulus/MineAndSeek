...
execute if score #game_state mas.counters = #LOCKER mas.enums as @a[team=mas.spectator] if score @s mas.ids = #check_id mas.ids run tag @s add mas.check
...
execute if score #game_state mas.counters = #IN_GAME mas.enums as @a[tag=mas.player] if score @s mas.ids = #check_id mas.ids run tag @s add mas.check
execute if score #game_state mas.counters = #POST_GAME mas.enums as @a[tag=mas.player] if score @s mas.ids = #check_id mas.ids run tag @s add mas.check
