...
#WARNING (25s)
title @s[scores={mas.counters=500}] title ["",{"text":"Warning","bold":false,"italic":false,"color":"white"}]
title @s[scores={mas.counters=500}] subtitle ["",{"text":"You will be revealed soon unless you move!","bold":false,"italic":false,"color":"white"}]
