...
execute if score @p[x=0,y=0,z=0,dx=95,dy=95,dz=95] mas.ids = @s mas.ids unless entity @s[distance=..5] run tp @s @p

#IDLE EFFECT PROCS
execute if score @p[x=0,y=0,z=0,dx=95,dy=95,dz=95,scores={mas.counters=25}] mas.ids = @s mas.ids run tp @s @p
execute if score @p[x=0,y=0,z=0,dx=95,dy=95,dz=95,scores={mas.counters=30}] mas.ids = @s mas.ids run tp @s @p